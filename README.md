...
(2019년 7월 - 현재)
> 모바일 앱 개발자로서 React Native로 사내 프로젝트의 모바일 앱을 제작하고 있습니다.
* **우루루**,  서울 강남구 — 개발팀 사원
(2017년 9월 - 2019년 7월)
...
#### 식사일기
* 기간: 2019.10.18 - 현재
* 주사용기술: React Native, Typescript, MobX-State-Tree(MST), AWS Amplify, AWS Cognito, AWS AppSync, AWS S3, AWS DynamoDB
* 프로젝트 소개: 오늘 먹은 음식을 편하게 기록하고 다양한 방법으로 되돌아 볼 수 있는 서비스입니다.
* 수행 역할: 식사일기의 모바일 앱 제작을 담당하여 React Native로 Android, iOS 앱을 제작, AWS의 Cognito를 사용하여 구글 계정으로 로그인 연결, AppSync를 사용하여 S3에 사진을 저장하고 해당 데이터를 DynamoDB에 저장, AppSync의 GraphQL로 쿼리하여 데이터 보여주기 및 업데이트
